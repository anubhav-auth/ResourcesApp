...
class EarningIdeasFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_earing_ideas, container, false)
        rv = view.findViewById(R.id.recyclerView_earning_ideas)
        listings()
        return view
    }
...
*/lists!!.add(listingModel("", "", ""))
    ...
    companion object {
        fun newInstance(): EarningIdeasFragment {
            return EarningIdeasFragment()
        }
    }
}