...
class NFTGeneratorFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_n_f_t_generator, container, false)
        rv = view.findViewById(R.id.recyclerView_NFTGenerator)
        listings()
        return view
    }
...
*/lists!!.add(listingModel("", "", ""))
    ...
    companion object {
        fun newInstance(): NFTGeneratorFragment {
            return NFTGeneratorFragment()
        }
    }
}