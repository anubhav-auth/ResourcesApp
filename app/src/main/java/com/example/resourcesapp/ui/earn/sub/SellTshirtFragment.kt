...
class SellTshirtFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_sell_tshirt, container, false)
        rv = view.findViewById(R.id.recyclerView_sellTshirts)
        listings()
        return view
    }
...
*/lists!!.add(listingModel("", "", ""))
    ...
    companion object {
        fun newInstance(): SellTshirtFragment {
            return SellTshirtFragment()
        }
    }
}