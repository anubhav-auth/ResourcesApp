...
class MysteryShoppingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_mystery_shopping, container, false)
        rv = view.findViewById(R.id.recyclerView_mysteryShopping)
        listings()
        return view
    }
...
*/lists!!.add(listingModel("", "", ""))
    ...
    companion object {
        fun newInstance(): MysteryShoppingFragment {
            return MysteryShoppingFragment()
        }
    }
}