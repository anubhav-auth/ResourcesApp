...
class WebsiteTestingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_website_testing, container, false)
        rv = view.findViewById(R.id.recyclerView_websiteTesting)
        listings()
        return view
    }
...
*/lists!!.add(listingModel("", "", ""))
    ...
    companion object {
        fun newInstance(): WebsiteTestingFragment {
            return WebsiteTestingFragment()
        }
    }
}