...
class DropShippingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_drop_shipping, container, false)
        rv = view.findViewById(R.id.recyclerView_dropShipping)
        listings()
        return view
    }
...
*/lists!!.add(listingModel("", "", ""))
    ...
    companion object {
        fun newInstance(): DropShippingFragment {
            return DropShippingFragment()
        }
    }
}