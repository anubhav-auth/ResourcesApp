...
class AffiliateMarketingFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_affiliate_marketing, container, false)
        rv = view.findViewById(R.id.recyclerView_affiliate_marketing)
        listings()
        return view
    }
...
*/lists!!.add(listingModel("", "", ""))
    ...
    companion object {
        fun newInstance(): AffiliateMarketingFragment {
            return AffiliateMarketingFragment()
        }
    }
}